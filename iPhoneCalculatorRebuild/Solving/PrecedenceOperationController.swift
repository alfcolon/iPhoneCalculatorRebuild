...
class PrecedenceOperationController: EvaluateNewOperator, RemovePrecedenceOperation, ReplacePrecedenceOperation {
    ...
    //MARK: - RemovePrecedenceOperation
    ...
    //MARK: - ReplacePrecedenceOperation
